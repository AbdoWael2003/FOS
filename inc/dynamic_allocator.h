...
struct MemBlock_LIST memory_list;
struct PA_block_LIST PA_LIST,USER_PA_LIST;

extern uint8 is_marked[NUM_OF_UHEAP_PAGES];
...
struct PA_block
{
	uint32 no_pages;
	uint32 va;
	LIST_ENTRY(PA_block) prev_next_info;
};
LIST_HEAD(PA_block_LIST, PA_block);
//===============================================================================================
